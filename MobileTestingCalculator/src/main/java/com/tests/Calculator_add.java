...
public class Calculator_add {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(5000);
        // Click 1
        driver.findElement(By.id("com.vivo.calculator:id/digit_1")).click();
        // Click +
        driver.findElement(By.id("com.vivo.calculator:id/op_add")).click();
        // Click 5
        driver.findElement(By.id("com.vivo.calculator:id/digit_5")).click();
        // Click =
        driver.findElement(By.id("com.vivo.calculator:id/eq")).click();
        System.out.println("Addition operation completed successfully");
        Thread.sleep(3000);
